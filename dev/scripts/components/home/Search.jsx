...
import {Grid, Row, Col, Button, Form, ControlLabel, FormGroup, FormControl, HelpBlock } from 'react-bootstrap';
          ...
          <Row>
            <Col xs={10} sm={6} md={5} xsOffset={1} mdOffset={2}>
              <div className="pokedex-main-search">
                ...
                <p className="sub-title">Use the Advanced Search to explore Pokemon by type, weakness, Ability, and more!</p>
              </div>
            </Col>
          </Row>
        </section>
